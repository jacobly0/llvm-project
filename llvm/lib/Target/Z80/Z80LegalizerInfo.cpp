...
Z80LegalizerInfo::Z80LegalizerInfo(const Z80Subtarget &STI,
  ...
  const LLT sMax = Is24Bit ? s24 : s16;
  const auto LegalTypes24 = {p0, s8, s16, s24}, LegalTypes16 = {p0, s8, s16};
  const auto LegalTypes = Is24Bit ? LegalTypes24 : LegalTypes16;
  const auto LegalScalars24 = {s8, s16, s24}, LegalScalars16 = {s8, s16};
  const auto LegalScalars = Is24Bit ? LegalScalars24 : LegalScalars16;
  const auto LegalLibcallScalars24 = {s8, s16, s24, s32, s64};
  const auto LegalLibcallScalars16 = {s8, s16, s32, s64};
  const auto LegalLibcallScalars =
      Is24Bit ? LegalLibcallScalars24 : LegalLibcallScalars16;
  const auto NotMax24 = {s8, s16}, NotMax16 = {s8};
  const auto NotMax = Is24Bit ? NotMax24 : NotMax16;
  const auto NotMin24 = {s16, s24}, NotMin16 = {s16};
  const auto NotMin = Is24Bit ? NotMin24 : NotMin16;
  const auto NotMaxWithOne24 = {s1, s8, s16}, NotMaxWithOne16 = {s1, s8};
  const auto NotMaxWithOne = Is24Bit ? NotMaxWithOne24 : NotMaxWithOne16;
