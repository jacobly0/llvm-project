...
static const TargetRegisterClass *getRegClassFromGRPhysReg(unsigned Reg) {
  ...
  if (Z80::R24RegClass.contains(Reg))
    return &Z80::R24RegClass;
  if (Z80::R16RegClass.contains(Reg))
    return &Z80::R16RegClass;
  if (Z80::R8RegClass.contains(Reg))
    return &Z80::R8RegClass;
...
bool Z80InstructionSelector::selectLoadStoreOp(MachineInstr &I,
  ...
  bool IsFrameIdx = PtrMI && PtrMI->getOpcode() == TargetOpcode::G_FRAME_INDEX;
  unsigned Opc;
  switch (Ty.getSizeInBits()) {
  case 8:
    Opc = IsFrameIdx ? IsStore ? Z80::LD8og : Z80::LD8go
                     : IsStore ? Z80::LD8pg : Z80::LD8gp;
    break;
  case 16:
    Opc = STI.has16BitEZ80Ops()
              ? IsFrameIdx ? IsStore ? Z80::LD16or : Z80::LD16ro
                           : IsStore ? Z80::LD16pr : Z80::LD16rp
              : IsFrameIdx ? IsStore ? Z80::LD88or : Z80::LD88ro
                           : IsStore ? Z80::LD88pr : Z80::LD88rp;
    break;
  case 24:
    assert(STI.is24Bit() && "Illegal memory access size.");
    Opc = IsFrameIdx ? IsStore ? Z80::LD24or : Z80::LD24ro
  ...
  if (IsFrameIdx)
    MIB.add(PtrMI->getOperand(1)).addImm(0);
  else
    MIB.addReg(PtrReg);
  if (IsStore)
    MIB.addReg(DefReg);
...
bool Z80InstructionSelector::selectFrameIndexOrGep(MachineInstr &I,
  ...
  if (Opc == TargetOpcode::G_PTR_ADD) {
    Register Op2Reg = I.getOperand(2).getReg();
    auto Off = getConstantVRegVal(Op2Reg, MRI);
    if (!Off || !isInt<8>(*Off)) {
      I.setDesc(TII.get(STI.is24Bit() ? Z80::ADD24ao : Z80::ADD16ao));
      return constrainSelectedInstRegOperands(I, TII, TRI, RBI);
    }
  ...
  I.setDesc(TII.get(STI.is24Bit() ? Z80::LEA24ro : Z80::LEA16ro));
...
bool Z80InstructionSelector::selectUnmergeValues(MachineInstr &I,
  ...
  case 24: {
    ...
    BuildMI(*I.getParent(), I, I.getDebugLoc(), TII.get(Z80::LD24or))
        .addFrameIndex(FI).addImm(0).add(I.getOperand(3));
    BuildMI(*I.getParent(), I, I.getDebugLoc(), TII.get(Z80::LD8ro))
        .add(I.getOperand(2)).addFrameIndex(FI).addImm(2);
    BuildMI(*I.getParent(), I, I.getDebugLoc(), TII.get(TargetOpcode::COPY))
        .add(I.getOperand(1))
  ...
  default: llvm_unreachable("Illegal instruction");
  }
  I.eraseFromParent();
  return true;
}
...
bool Z80InstructionSelector::selectMergeValues(MachineInstr &I,
  ...
  case 16:
    ...
    NewI = BuildMI(*I.getParent(), I, I.getDebugLoc(),
               ...
               .add(I.getOperand(1)).addImm(Z80::sub_low)
               .add(I.getOperand(2)).addImm(Z80::sub_high);
  ...
  case 24: {
    ...
    BuildMI(*I.getParent(), I, I.getDebugLoc(), TII.get(Z80::LD24ro), Temp1Reg)
        .addFrameIndex(FI).addImm(-2);
    BuildMI(*I.getParent(), I, I.getDebugLoc(), TII.get(Z80::INSERT_SUBREG),
            Temp2Reg).addReg(Temp1Reg)
        .add(I.getOperand(2)).addImm(Z80::sub_high);
    NewI = BuildMI(*I.getParent(), I, I.getDebugLoc(),
                   TII.get(Z80::INSERT_SUBREG), DstReg)
               .addReg(Temp2Reg).add(I.getOperand(1)).addImm(Z80::sub_low);
...
Z80InstructionSelector::foldCompare(MachineInstr &I, MachineIRBuilder &MIB,
  ...
  if (IsSigned && OptSize) {
    ...
    if (!RBI.constrainGenericRegister(FlagsReg, Z80::R8RegClass, MRI) ||
        !RBI.constrainGenericRegister(SignedFlagsReg, Z80::R8RegClass, MRI))
      return Z80::COND_INVALID;
  }
  return CC;
}
...
Z80::CondCode Z80InstructionSelector::foldCond(Register CondReg,
  ...
  if (CC == Z80::COND_INVALID) {
    ...
    auto BitI = MIB.buildInstr(Z80::BIT8bg, {}, {CondReg, int64_t(0)});
    if (constrainSelectedInstRegOperands(*BitI, TII, TRI, RBI))
      CC = Z80::COND_NZ;
  }
