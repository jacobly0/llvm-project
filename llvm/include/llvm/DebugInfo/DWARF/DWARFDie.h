...
public:
  ...
  LLVM_ABI std::optional<uint64_t> getDeclLine() const;
  LLVM_ABI std::optional<uint64_t> getDeclColumn() const;
  LLVM_ABI std::optional<uint64_t> getDeclFileIndex() const;
  LLVM_ABI std::string
