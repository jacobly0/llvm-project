...
public:
  ...
  class ExtInfo {
    ...
    // Feel free to rearrange or add bits, but if you go over 13,
    // you'll need to adjust both the Bits field below and
    // Type::FunctionTypeBitfields.

    //   |  CC  |noreturn|produces|nocallersavedregs|regparm|nocfcheck|tiflags|
    ...
    enum { TIFlagsMask = 0x1000 };
    enum {
      RegParmMask = ~(CallConvMask | NoReturnMask | ProducesResultMask |
                      NoCallerSavedRegsMask | NoCfCheckMask | TIFlagsMask),
      RegParmOffset = 8
  ...
  public:
    ...
    ExtInfo(bool noReturn, bool hasRegParm, unsigned regParm, CallingConv cc,
      ...
      Bits = ((unsigned)cc) | (noReturn ? NoReturnMask : 0) |
             ...
             (NoCfCheck ? NoCfCheckMask : 0) | (TIFlags ? TIFlagsMask : 0);
    }
