...
#ifndef LLDB_SOURCE_PLUGINS_HIGHLIGHTER_ZIG_ZIGLEXER_H
#define LLDB_SOURCE_PLUGINS_HIGHLIGHTER_ZIG_ZIGLEXER_H
...
#endif // LLDB_SOURCE_PLUGINS_HIGHLIGHTER_ZIG_ZIGLEXER_H
