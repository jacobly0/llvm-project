...
public:
  ...
  llvm::ArrayRef<uint8_t> GetData() const {
    return llvm::ArrayRef(getTrailingObjects(), GetType()->GetByteSize());
  }
...
public:
  ...
  llvm::ArrayRef<llvm::APInt::WordType> GetWords() const {
    return llvm::ArrayRef(getTrailingObjects(), m_words);
  }
...
public:
  ...
  llvm::ArrayRef<llvm::APInt::WordType> GetWords() const {
    return llvm::ArrayRef(getTrailingObjects(),
...
public:
  ...
  llvm::ArrayRef<ZigType *> GetParamTypes() const {
    return llvm::ArrayRef(getTrailingObjects(), m_num_params);
  }
...
public:
  ...
  llvm::ArrayRef<ZigTupleField> GetFields() const {
    return llvm::ArrayRef(getTrailingObjects(), m_num_fields);
  }
  bool HasNoPossibleValues() const final {
