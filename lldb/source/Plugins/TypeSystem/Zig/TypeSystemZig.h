...
public:
...
#ifndef NDEBUG
  bool VerifyDeclContext(void *opaque_decl_ctx) const;
  bool VerifyDecl(void *opaque_decl) const;
  bool Verify(lldb::opaque_compiler_type_t type) const;
  ...
  bool IsIndexableType(lldb::opaque_compiler_type_t type,
                       bool *is_incomplete) override;
  ...
  ZigScope *UnwrapScope(void *opaque_decl_ctx) const;
  ZigScope *UnwrapScope(CompilerDeclContext decl_ctx) const;
  ZigScope *UnwrapScope(ZigScope *) const = delete;
  ZigScope *UnwrapScope(ZigValue *) const = delete;

  CompilerDecl WrapDecl(ZigDeclaration *zig_decl = nullptr);
  ZigDeclaration *UnwrapDecl(void *opaque_decl) const;
  ZigDeclaration *UnwrapDecl(CompilerDecl decl) const;
  ZigDeclaration *UnwrapDecl(ZigScope *) const = delete;
  ZigDeclaration *UnwrapDecl(ZigValue *) const = delete;

  CompilerType WrapType(ZigType *zig_type = nullptr);
  ZigType *UnwrapType(lldb::opaque_compiler_type_t type) const;
  ZigType *UnwrapType(CompilerType type) const;
  ZigType *UnwrapType(ZigScope *) const = delete;
  ZigType *UnwrapType(ZigValue *) const = delete;
