...
public:
  ...
  ZigConstant *GetConstant(void *opaque_decl_ctx, ConstString name,
                           ZigValue *value);
  ZigAlias *GetAlias(void *opaque_decl_ctx, ConstString name, ZigValue *value);
  ...
  bool DumpValue(ZigValue *value, Stream &s, const ExecutionContext &exe_ctx);
...
private:
  ...
  ZigUndefined *m_undefined = nullptr;
  ZigNull *m_null = nullptr;
