...
ZigVoid::ZigVoid(TypeSystemZig *type_system)
    : ZigValue(type_system, Kind::Void,
               type_system->UnwrapType(type_system->GetVoidType())) {}
...
ZigUndefined::ZigUndefined(TypeSystemZig *type_system)
    : ZigValue(type_system, Kind::Undefined,
               type_system->UnwrapType(type_system->GetUndefinedType())) {}
...
ZigNull::ZigNull(TypeSystemZig *type_system)
    : ZigValue(type_system, Kind::Null,
               type_system->UnwrapType(type_system->GetNullType())) {}
...
ZigRecordField::ZigRecordField(bool is_comptime, ConstString name,
                               ZigType *type, llvm::MaybeAlign align,
                               ZigValue *default_value, uint64_t bit_offset)
